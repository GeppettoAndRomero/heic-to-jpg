...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/heic-to-jpg/sw.js, scope=/heic-to-jpg/）。
    // scope がツールの全 locale ページ（/heic-to-jpg/, /heic-to-jpg/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/heic-to-jpg/sw.js', {
      scope: '/heic-to-jpg/',
    });
