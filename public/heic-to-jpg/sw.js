...
const PRECACHE_URLS = [
  '/heic-to-jpg/',
  '/heic-to-jpg/manifest.json',
  '/heic-to-jpg/icon-192.png',
  '/heic-to-jpg/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/heic-to-jpg/manifest.json';
}
